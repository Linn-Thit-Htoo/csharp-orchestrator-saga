...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<TblEventStream> TblEventStreams { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblEvent>(entity =>
        {
            ...
            entity.Property(e => e.EventType).HasColumnType("character varying");
            entity.Property(e => e.StreamId).HasDefaultValueSql("gen_random_uuid()");

            entity.HasOne(d => d.Stream).WithMany(p => p.TblEvents)
                .HasForeignKey(d => d.StreamId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Tbl_Event_StreamId_fkey");
        });

        modelBuilder.Entity<TblEventStream>(entity =>
        {
            entity.HasKey(e => e.StreamId).HasName("Tbl_EventStream_pkey");

            entity.ToTable("Tbl_EventStream");

            entity.Property(e => e.StreamId).HasDefaultValueSql("gen_random_uuid()");
            entity.Property(e => e.AggregateType).HasColumnType("character varying");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("now()")
                .HasColumnType("timestamp without time zone");
        });
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("Tbl_Order_pkey");
        ...
        {
            entity.HasKey(e => e.Id).HasName("Tbl_OrderDetail_pkey");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("Tbl_Product_pkey");

            entity.ToTable("Tbl_Product");

            entity.HasIndex(e => e.ProductId, "Tbl_Product_ProductId_key").IsUnique();
        ...
        {
            entity.HasKey(e => e.StockId).HasName("Tbl_Stock_pkey");

            entity.ToTable("Tbl_Stock");

            entity.Property(e => e.StockId).HasDefaultValueSql("gen_random_uuid()");
            entity.Property(e => e.ProductId).HasDefaultValueSql("gen_random_uuid()");

            entity.HasOne(d => d.Product).WithMany(p => p.TblStocks)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Tbl_Stock_ProductId_fkey");
        });
